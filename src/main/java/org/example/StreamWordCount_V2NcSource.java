...
public class StreamWordCount_V2NcSource {
    public static void main(String[] args) throws Exception {
        ...
        // 通过  netcat -lk 7777 启动一个服务
        // 在 main 方法中传递参数 --host 192.168.0.48 --port 7777
        DataStreamSource<String> source = env.socketTextStream(fromArgs.get("host"), fromArgs.getInt("port"));
